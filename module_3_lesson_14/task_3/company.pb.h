...
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void Company::set_companyname(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.companyname_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:Company.companyName)
}
inline std::string* PROTOBUF_NONNULL Company::mutable_companyname()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL Company::_internal_mutable_companyname() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.companyname_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE Company::release_companyname() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void Company::set_allocated_companyname(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
...
inline const std::string& Company::industry() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Company.industry)
...
PROTOBUF_ALWAYS_INLINE void Company::set_industry(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Company.industry)
}
inline std::string* PROTOBUF_NONNULL Company::mutable_industry()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_industry();
  // @@protoc_insertion_point(field_mutable:Company.industry)
  return _s;
}
...
inline std::string* PROTOBUF_NULLABLE Company::release_industry() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Company.industry)
...
inline void Company::set_allocated_industry(std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Company.industry)
}
